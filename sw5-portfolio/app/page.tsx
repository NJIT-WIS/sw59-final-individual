    ...
    <main>
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse  bg-[#35938D]">
          ...
          />
          <div>
            <p className="text-5xl font-bold text-[#5A1EBC]">
              Hi ! I&apos;m Shunji{" "}
            </p>
            <p className=" mt-6 text-5xl font-bold text-[#5A1EBC]">
              BS/DS <span className="text-[#E79D0F]">Specialist</span>
            </p>
            <p
              className="py-6"
              style={{
            ...
            >
              Making the power of data-driven decision making accessible to all.
            </p>
            <div className=" mt-6">
              ...
              <div className="flex gap-4 items-center">
                <input
                  ...
                  className="input w-80 max-w-xs disabled"
                  value={email}
            ...
            <div className="flex gap-20 mt-32">
              ...
              <div>
                <span className={"font-bold text-6xl text-[#1F5DFC]"}>
                  120+
                </span>
