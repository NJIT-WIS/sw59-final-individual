    ...
    <main>
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <Image src="/hero.png" width={410} height={524} alt='sw5 porfolio' className={'mb-16'} />
          <div>
            ...
            <p className="py-6">Making the power of data-driven decision making accessible to all.</p>
            <div className=' mt-6'>
              ...
              <div className='flex gap-11 mt-8'>
                ...
                <div className='flex gap-1'>
                  ...
                  <a href='https://github.com/sw59'><span>
                    Github
                  </span>
                  </a>
                </div>
